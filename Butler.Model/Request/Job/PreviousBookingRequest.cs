...
{
    public class PreviousBookingResponse : Response
    {
        public List<Job> Data { get; set; }
       
    }

    public class PreviousBookingRequest
    {
        public int CustomerId { get; set; }
        private ButlerEntities _dbContext = new ButlerEntities();
        public object RunRequest(PreviousBookingRequest req)
        {
            var response = new PreviousBookingResponse();
